...
class BioveTransactionFailedAdmin extends StatefulWidget {

  @override
  _BioveTransactionFailedAdminState createState() => _BioveTransactionFailedAdminState();
}

class _BioveTransactionFailedAdminState extends State<BioveTransactionFailedAdmin> {
  ...
  initStateAsync()async {
    _listTransactionModel = await Firestore.getTransactionFailed();
    setState(() {
      _initialize = false;
    });
  }
